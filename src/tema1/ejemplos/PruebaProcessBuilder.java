...
/**
 *********************************************************
 * pruebaProcessBuilder*************************************** A program 'to
 * play' with the java.lang.Runtime Java class
 *
    ...
    public static void main(String[] args) {
        ...
        while ((opcion = Menu.menu()) != Menu.opcionesMenu.end) {
            ...
            switch (opcion) {
                ...
                case start:
                    /*Modifying a process builder's attributes will affect processes subsequently started by that object's start() method, 
                ...
                case redirectInput:        //Set a new standard input source (of a subprocess)
                    ...
                    //1�) aProcessBuilder.redirectInput(aRedirect), aRedirect.Type!= Redirect.Type.PIPE 
                    //2�) aProcess=aProcessBuilder.start()
                    //3�) ----->outputStreamToSubprocessInput=aProcess.getInputStream() == null inputStream  
                    //4�) ----->outputStreamToSubprocessInput.write(salida)----->IOException
                ...
                case redirectOutput:       //Set a new standard output destination (of a subprocess)
                    ...
                    //1�) aProcessBuilder.redirectOutput(aRedirect), aRedirect.Type!= Redirect.Type.PIPE 
                    //2�) aProcess=aProcessBuilder.start()
                    //3�) ----->inputStreamToSubprocessOutput=aProcess.getInputStream() == null inputStream  
                    //4�) ----->inputStreamToSubprocessOutput.read(entrada)----->returns -1
                    //                                       .available()  -----> returns 0
                ...
                case redirectError:        //Set a new standard error destination (of a subprocess)
                    ...
                    //1�) aProcessBuilder.redirectError(aRedirect), aRedirect.Type!= Redirect.Type.PIPE 
                    //2�) aProcess=aProcessBuilder.start()
                    //3�) ----->inputStreamToSubprocessOutput=aProcess.getInputStream() == null inputStream  
                    //4�) ----->inputStreamToSubprocessOutput.read(entrada)----->returns -1
                    //                                       .available()  -----> returns 0
                ...
                case setRedirectErrorStream:
                    /* Initially, this property is false, meaning that the standard output and error output of a subprocess are sent to two separate streams, which can be accessed using the Process.getInputStream() and Process.getErrorStream() methods. 
                ...
                case seeRedirectInput:
                    /*Returns this process builder's standard input source. Subprocesses subsequently started by this object's start() method 
                ...
                case seeRedirectOutput:
                    /*Returns this process builder's standard output destination. Subprocesses subsequently started by this object's start() method 
                ...
                case seeRedirectError:
                    /*Returns this process builder's standard error destination. Subprocesses subsequently started by this object's start() method 
                ...
                case getInputStreamFromSubprocessError:
                    try {
